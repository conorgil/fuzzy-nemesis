...
public class MainActivity extends Activity {
	...
	// TODO probably don't create static final instance - need to pass emails to this somehow
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//TODO read the enabled/disabled setting from file or the savedInstanceState
	...
	private void registerSmsReceiver() {
		...
		getApplicationContext().registerReceiver(SMS_RECEIVER, new IntentFilter(action));
	}
